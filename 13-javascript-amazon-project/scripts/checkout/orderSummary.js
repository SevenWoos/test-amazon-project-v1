...
// Regenerate the OrderSummary HTML
export function renderOrderSummary() {
  // Use cart items to generate the HTML.
  // Use each cartItem's productId to search for the product in our dataset.
  let cartSummaryHTML = '';
      ...
      <div class="cart-item-container 
        ...
        <div class="cart-item-details-grid">
          ...
          <div class="delivery-options">
            ...
            ${deliveryOrdersHTML(matchingProduct, cartItem)}
          </div>
        </div>
      </div>
    `
  ...
  function deliveryOrdersHTML(matchingProduct, cartItem) {
    let html = '';

    // Loop through each delivery options.
    // For each option, generate the HTML.
  ...
  document.querySelectorAll('.js-delete-link')
    .forEach((link) => {
      link.addEventListener('click', () => {
        ...
        // Regenerate the Payment Summary HTML when clicking delete using MVC.
